...
.enter	.content  .recommend h3,.enter	.content  .hotbox h3{
	display: block;
	width:100%;
	height:50px;
	font-size:16px;
...
.enter	.content  .recommend h3 span,.enter	.content  .hotbox h3 span{
	margin-right: 10px;
	float: right;   
	 font-size: 14px;
    color: #d2525b
...
.enter	.content  .recommend .con dl:hover p,.enter	.content  .recommend .con dl:hover span{
	color: #de482f;
}
...
.enter	.content  .hotbox .con dl:hover p,.enter	.content  .hotbox .con dl:hover span{
	color: #de482f;
}
