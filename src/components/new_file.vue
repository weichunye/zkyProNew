	...
	<div class="searchTop">
		<div class="header-top">
			<div class="reposbox">
				...
				<div v-if="showLogin">
					<a class="right-text" @click="toLogin" href="javascript:;">注册 </a>
					<a class="right-text" href="javascript:;">登录 &nbsp;&nbsp;&nbsp;|</a>
				</div>
				<p @click="toPersonalInfo" v-else="" class="right-text">个人中心</p>
			</div>
		</div>
		<div class="top-box">
			<div class="con">
  			...
  			在文档使用中是否遇到以下问题：
				...
				<el-form-item label=" " style="float: right;">
					<el-checkbox v-model="formdialogFeedback.ifAnonymous">
						<router-link target="_blank" to="page2">是否匿名</router-link>
					</el-checkbox>
			...
			<el-form :model="form" ref="form" :rules="rules" :inline="true" class="demo-form-inline" @submit.native.prevent>
				...
				<div class="box-small">
					...
					<el-form-item prop="opensourceType" label="开源类型" :label-width="formLabelWidth">
						<el-select v-model="form.opensourceType" value-key="id" filterable multiple placeholder="请选择">
					...
					<el-form-item prop="softCategory" label="软件类别" :label-width="formLabelWidth">
						<el-select v-model="form.softCategory" value-key="id" filterable multiple placeholder="请选择">
					...
					<el-form-item prop="Language" label="编程语言" :label-width="formLabelWidth">
						<el-select v-model="form.Language" value-key="id" filterable multiple placeholder="请选择">
				...
				<div class="box-small">
					<el-form-item prop="userInterface" label="用户接口" :label-width="formLabelWidth">
						<el-select v-model="form.userInterface" value-key="id" filterable multiple placeholder="请选择">
					...
					<el-form-item prop="applicationField" label="应用领域" :label-width="formLabelWidth">
						<el-select v-model="form.applicationField" value-key="id" filterable multiple placeholder="请选择">
					...
					<div class="left-box">
						<el-form-item label=" " :label-width="formLabelWidth">
							<el-checkbox v-model="form.ifCheckedMzs">
								<router-link target="_blank" to="page2">软件投递免责协议</router-link>
							</el-checkbox>
...
<style>
	...
	.searchTop .box-big .el-input__inner,
