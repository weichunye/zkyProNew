   	...
   	getList:function(){
		...
		if(typeId=='isRecommend'){
   		...
   		params.append("limit", _this.limit);
   			...
   			_this.axios.post(baseUrl.baseUrl+'/web/soft/querySoftListByCondition',params)
   		.then(function(response){
			console.log("response1111",	response)
   			_this.softData=response.data.page.list;
   			_this.totalPage=response.data.page.totalCount
