...
<script>
    ...
    export default {
        ...
        mounted() {
            //获取活动基本信息
            var _this = this;
            console.log("this.userId11",this.userId)
            _this.getListOption()
            _this.getSoftInfo()
        ...
        methods: {
            ...
            getSoftInfo: function() {
                ...
                _this.axios.post(baseUrl.baseUrl + '/web/user/getSaveSoftDetail', params)
                    .then(function(response) {
                        ...
                        _this.form.openType = softInfoObg.opensourceTypes;//开源类型
            ...
            submitForm: function(formName) {
                ...
                var joinVo = {
                    ...
                    userList: [],
                    softSonCtyList: this.form.applicationField,//开发领域
                ...
                if(_this.form.openType.length == 0) {
                ...
                if(_this.form.operatingSystem.length == 0) {
                ...
                if(_this.form.softCategory.length == 0) {
                    _this.messageOpen('请填写收费方式', 'warning')
                    return false;
                }
                if(!_this.form.softUrl) {
