<template>
	<div class="enter">
		...
		<div class="contenttop">
            ...
            <li v-for="itemNew in item.children" >
              <router-link :to="{path:'/list',query:{categoryId:itemNew.value,categoryName:itemNew.label,ParentName:'首页'}}">
                <span>{{itemNew.label}}</span>
              </router-link>
              <router-link v-for="tihrdChild in itemNew.children" :to="{path:'/list',query:{categoryId:tihrdChild.value,categoryName:itemNew.label,ParentName:'首页'}}">
